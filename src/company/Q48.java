...
//        and oxygen threads will be given releaseHydrogen and releaseOxygen methods respectively,
...
//        know which other threads they are paired up with. The key is that threads pass the barriers in complete sets;
//        thus, if we examine the sequence of threads that bind and divide them into groups of three, each group should
